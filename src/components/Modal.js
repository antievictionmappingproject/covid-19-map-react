      ...
      <div className="modal">
        <div>
          <h4
            ...
            dangerouslySetInnerHTML={{ __html: t("modal.title") }}
          ></h4>
          <a
        ...
        <aside>
          ...
          <p
            data-i18n="modal.content.paragraph-1"
            dangerouslySetInnerHTML={{ __html: t("modal.content.paragraph-1") }}
          ></p>
          <p
            data-i18n="modal.content.paragraph-2"
